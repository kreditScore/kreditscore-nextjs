    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Get instant personal loan online from Γé╣50,000 to Γé╣25 lakh with minimal documentation. Quick approval in 24-72 hours with low interest rates starting from 9% p.a.",
            "provider": {
          ...
          <div className="grid lg:grid-cols-[2fr_0.7fr] gap-6 md:gap-8 mb-8 md:mb-12">
            ...
            >
              ...
              >
                ...
                <span className="whitespace-nowrap">One Loan, One EMI</span>
              </motion.div>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-2 sm:mb-3 md:mb-4 bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 bg-clip-text text-transparent leading-tight whitespace-nowrap">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-1.5 sm:gap-2 md:gap-3 lg:gap-4">
                <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-1.5 sm:p-2 md:p-3 lg:p-4 shadow-lg border border-gray-100">
                  <Wallet className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-blue-600 mb-0.5 sm:mb-1 md:mb-2" />
                  <p className="text-xs sm:text-sm md:text-base lg:text-lg font-bold text-gray-900 leading-tight">Personal Loans</p>
                  <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-700 font-semibold">14-18% Interest Rate</p>
                </div>
                <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-1.5 sm:p-2 md:p-3 lg:p-4 shadow-lg border border-gray-100">
                  <CreditCard className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-red-600 mb-0.5 sm:mb-1 md:mb-2" />
                  <p className="text-xs sm:text-sm md:text-base lg:text-lg font-bold text-gray-900 leading-tight">Credit Cards</p>
                  <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-700 font-semibold">Up to 45% Interest Rate</p>
                </div>
                <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-1.5 sm:p-2 md:p-3 lg:p-4 shadow-lg border border-gray-100">
                  <Zap className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-orange-600 mb-0.5 sm:mb-1 md:mb-2" />
                  <p className="text-xs sm:text-sm md:text-base lg:text-lg font-bold text-gray-900 leading-tight">App Loans</p>
                  <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-700 font-semibold">18-24% Interest Rate</p>
                </div>
                <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-1.5 sm:p-2 md:p-3 lg:p-4 shadow-lg border border-gray-100">
                  <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-purple-600 mb-0.5 sm:mb-1 md:mb-2" />
                  <p className="text-xs sm:text-sm md:text-base lg:text-lg font-bold text-gray-900 leading-tight">Overdrafts</p>
                  <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-700 font-semibold">12-15% Interest Rate</p>
                </div>
              </div>
            </motion.div>
                  ...
                  {!isSubmitted ? (
                    <>
                      <div className="text-center mb-3 sm:mb-4 md:mb-5 lg:mb-6">
                        ...
                        >
                          Γ£¿ Instant ΓÇó ≡ƒöÆ Secure ΓÇó ≡ƒô▒ Digital Process
                        </motion.p>
                      </div>
          ...
          <div className="mb-8 md:mb-12">
            <div className="overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              <div className="flex gap-4 sm:gap-6 md:gap-8 min-w-max px-1">
                ...
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-2xl flex items-center justify-center mb-3 sm:mb-4">
                    <Wallet className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" strokeWidth={2.5} />
                  </div>

                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-4 sm:mb-5">Consolidate These Debts:</h3>
                  <div className="space-y-2.5 sm:space-y-3 mb-4 sm:mb-5 flex-grow">
                    <div className="flex items-center gap-2.5 sm:gap-3 p-3 rounded-xl bg-blue-100/80 border border-blue-200">
                      <Wallet className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 flex-shrink-0" />
                      <div>
                        <p className="text-xs sm:text-sm font-semibold text-gray-800">Personal Loans</p>
                        <p className="text-[10px] sm:text-xs text-gray-700">14-18% interest</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2.5 sm:gap-3 p-3 rounded-xl bg-red-100/70 border border-red-200">
                      <CreditCard className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 flex-shrink-0" />
                      <div>
                        <p className="text-xs sm:text-sm font-semibold text-gray-800">Credit Cards</p>
                        <p className="text-[10px] sm:text-xs text-gray-700">Up to 45% interest</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2.5 sm:gap-3 p-3 rounded-xl bg-orange-100/70 border border-orange-200">
                      <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600 flex-shrink-0" />
                      <div>
                        <p className="text-xs sm:text-sm font-semibold text-gray-800">App Loans</p>
                        <p className="text-[10px] sm:text-xs text-gray-700">18-24% interest</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2.5 sm:gap-3 p-3 rounded-xl bg-purple-100/80 border border-purple-200">
                      <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 flex-shrink-0" />
                      <div>
                        <p className="text-xs sm:text-sm font-semibold text-gray-800">Overdrafts</p>
                        <p className="text-[10px] sm:text-xs text-gray-700">12-15% interest</p>
                      </div>
                    </div>
                    <div className="rounded-xl border border-fuchsia-200 bg-gradient-to-r from-fuchsia-500 to-pink-500 p-3 sm:p-3.5">
                      <div className="flex items-center gap-2">
                        <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-white flex-shrink-0" />
                        <div>
                          <p className="text-xs sm:text-sm font-bold text-white">After Consolidation</p>
                          <p className="text-[10px] sm:text-xs text-white/90">All 4 Loans Combined into One EMI</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Why Debt Consolidation?</h3>
                  <div className="flex-grow space-y-1.5 sm:space-y-2 mb-4 sm:mb-5">
                    {[
                      'Reduce EMI burden by up to 50%',
                      'One single EMI instead of multiple EMI',
                      'Significantly lower interest rates 9.95%',
                      'Improve credit score',
                      'Better cash flow',
                      'financial management',
                    ].map((item, idx) => (
                      <div key={idx} className="flex items-start gap-1.5 sm:gap-2">
                        <CheckCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                        <span className="text-[10px] sm:text-xs md:text-sm text-gray-700 leading-tight">{item}</span>
                      </div>
                    ))}
                  </div>
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "You can get a personal loan from Γé╣50,000 to Γé╣25 lakh, depending on your monthly income, credit score, and repayment capacity."
                }
              }
            ]
          })
      ...
      <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-6 md:py-8 text-center relative z-10">
        <div className="max-w-7xl mx-auto px-3 md:px-4">
          ...
          <p className="text-[10px] sm:text-xs text-gray-400 mt-1 md:mt-2">Secure ΓÇó Fast ΓÇó Trusted</p>
        </div>
      </footer>
    </div>
  );
