    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      ...
      <section className="pt-24 sm:pt-28 lg:pt-32 pb-8 sm:pb-12 lg:pb-16 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Main Grid: 2 Columns Layout - Left: Banner + Salaried Box, Right: Form + Credit Cards */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">

            {/* LEFT COLUMN: 0% EMI Banner + Green Salaried Overdraft Box */}
            <div className="space-y-6">
              ...
              >
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 rounded-3xl p-1 shadow-2xl">
                    <div className="bg-white rounded-3xl px-8 py-6 sm:px-12 sm:py-8 flex items-center gap-4 sm:gap-6">
                      {/* Tag Icon */}
                      <motion.div
                    animate={{
                      rotate: [0, 10, -10, 0],
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-emerald-400 rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-500"></div>
                <motion.div
                  className="relative bg-gradient-to-br from-green-500 to-emerald-600 rounded-3xl p-6 sm:p-8 shadow-2xl"
              ...
              >
                <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-4">How It Works:</h3>
              ...
              {/* Key Benefits */}
              <motion.div
                className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl p-6 shadow-lg"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.5 }}
              >
                <h3 className="text-lg sm:text-xl font-bold text-green-800 mb-4">Key Benefits:</h3>
            ...
            {/* RIGHT COLUMN: Application Form + Credit Cards */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              <div className="space-y-4 max-w-sm mx-auto">
                ...
                >
                  <div className="text-white text-center">
                    ...
                    <div className="text-3xl font-bold mb-1">Up to 45%</div>
                ...
                >
                  <div className="text-white text-center">
                    ...
                    <h3 className="text-lg font-bold mb-2">Regular OD</h3>
          ...
          <div className="mb-8 sm:mb-12">
            ...
            >
              {/* Key Features Card */}
              <motion.div
                className="bg-gradient-to-br from-teal-500 via-green-500 to-emerald-500 rounded-3xl p-6 sm:p-8 shadow-2xl"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.3 }}
              >
                ...
                <ul className="space-y-3">
                  <li className="flex items-start text-white">
                    ...
                    <span className="text-sm sm:text-base">Revolving Credit Facility</span>
                  </li>
                  <li className="flex items-start text-white">
                    <CheckCircle2 className="w-5 h-5 mr-2 flex-shrink-0 mt-1" />
                    <span className="text-sm sm:text-base">Pay Interest on Usage Only</span>
                  </li>
                  <li className="flex items-start text-white">
                    <CheckCircle2 className="w-5 h-5 mr-2 flex-shrink-0 mt-1" />
                    <span className="text-sm sm:text-base">Instant Fund Transfer</span>
                  </li>
                  <li className="flex items-start text-white">
                    <CheckCircle2 className="w-5 h-5 mr-2 flex-shrink-0 mt-1" />
                    <span className="text-sm sm:text-base">No Foreclosure Charges</span>
                  </li>
                </ul>
              </motion.div>
              ...
              {/* Statistics Card */}
              <motion.div
                className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border-2 border-green-200"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.3 }}
              >
                <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-4">Success Stories</h3>
                <div className="space-y-4">
                  <div className="text-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                    <div className="text-2xl sm:text-3xl font-bold text-green-600">15,000+</div>
                  ...
                  <div className="text-center p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl">
                    <div className="text-2xl sm:text-3xl font-bold text-emerald-600">₹750 Cr+</div>
                    <div className="text-xs sm:text-sm text-gray-600">Credit Approved</div>
                  </div>
                  <div className="text-center p-4 bg-gradient-to-r from-teal-50 to-green-50 rounded-xl">
                    <div className="text-2xl sm:text-3xl font-bold text-teal-600">4.9/5</div>
