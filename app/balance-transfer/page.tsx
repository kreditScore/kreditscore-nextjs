...
export default function BalanceTransferPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-rose-50 to-pink-50">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Transfer your existing loans to lower interest rates and reduce EMI by up to 50%",
            "provider": {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-[16px] leading-tight sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 px-2">
              ...
              <span className="text-gray-700">Balance Transfer Loan</span>
            </h1>
            <p className="text-[12px] sm:text-lg md:text-xl lg:text-2xl text-gray-700 mb-2 sm:mb-3 px-2 leading-tight">
              Reduce Your EMI by 50%
            </p>
            <p className="text-[10px] sm:text-base md:text-lg text-red-600 font-semibold px-2 leading-tight">
              @ Lower Interest Rates from 10.5% p.a.*
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            >
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-600 rounded-2xl sm:rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-500"></div>
                <div className="relative bg-gradient-to-br from-red-500 to-red-600 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl transform group-hover:scale-105 transition-all duration-500">
                  <div className="flex items-center justify-center mb-3 sm:mb-4">
                    <div className="bg-white/20 backdrop-blur-sm p-3 sm:p-4 rounded-2xl">
                      <BarChart3 className="w-10 h-10 sm:w-16 sm:h-16 text-white" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center space-x-2 sm:space-x-3 bg-white/10 backdrop-blur-sm rounded-xl p-2 sm:p-3">
                      ...
                      <span className="text-white text-xs sm:text-sm lg:text-base font-medium">Reduce the EMI 50%</span>
                    </div>
                    <div className="flex items-center space-x-2 sm:space-x-3 bg-white/10 backdrop-blur-sm rounded-xl p-2 sm:p-3">
                      <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-white flex-shrink-0" />
                      <span className="text-white text-xs sm:text-sm lg:text-base font-medium">Docs will be Required</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl">
                <h3 className="text-base sm:text-lg lg:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Why Balance Transfer?</h3>
                <div className="space-y-2 sm:space-y-3">
                  
                  <div className="flex items-center space-x-3 p-2 sm:p-3 bg-gradient-to-r from-red-50 to-rose-50 rounded-lg">
                    <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 text-red-600" />
                    <div>
                      <p className="text-xs sm:text-sm font-semibold text-gray-800">Lower Interest Rate</p>
                      <p className="text-xs text-gray-600">10.5% vs 18-24% current</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-2 sm:p-3 bg-gradient-to-r from-red-50 to-rose-50 rounded-lg">
                    <Calculator className="w-5 h-5 sm:w-6 sm:h-6 text-red-600" />
                    <div>
                      <p className="text-xs sm:text-sm font-semibold text-gray-800">Reduce Monthly EMI</p>
                      <p className="text-xs text-gray-600">Save up to 50% per month</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-2 sm:p-3 bg-gradient-to-r from-red-50 to-rose-50 rounded-lg">
                    <FileText className="w-5 h-5 sm:w-6 sm:h-6 text-red-600" />
                    <div>
                      <p className="text-xs sm:text-sm font-semibold text-gray-800">Consolidate Multiple Loans</p>
                      <p className="text-xs text-gray-600">Combine all into one EMI</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-2 sm:p-3 bg-gradient-to-r from-red-50 to-rose-50 rounded-lg">
                    <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-red-600" />
                    <div>
                      <p className="text-xs sm:text-sm font-semibold text-gray-800">Better Terms</p>
                      <p className="text-xs text-gray-600">Flexible tenure options</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Key Benefits */}
              <div className="bg-gradient-to-br from-red-50 to-rose-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
                <h3 className="text-base sm:text-lg lg:text-xl font-bold text-red-800 mb-3 sm:mb-4">Key Benefits:</h3>
                <ul className="space-y-2 sm:space-y-3">
                  
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-xs sm:text-sm text-gray-700">Significantly lower interest rates</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-xs sm:text-sm text-gray-700">Reduce monthly financial burden</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-xs sm:text-sm text-gray-700">Consolidate multiple high-interest loans</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-xs sm:text-sm text-gray-700">Improved credit score over time</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-xs sm:text-sm text-gray-700">Transparent pricing structure</span>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 sticky top-24">
                <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
                  <Calculator className="w-6 h-6 sm:w-8 sm:h-8 text-red-600" />
                ...
                <div className="mb-4 sm:mb-6">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm sm:text-lg font-bold text-red-600">₹{loanAmount.toLocaleString('en-IN')}</span>
                  </div>
                  <input
                    type="range"
                    min="100000"
                    ...
                    className="w-full h-2 bg-gradient-to-r from-red-50 to-rose-50 rounded-lg appearance-none cursor-pointer accent-red-600"
                  />
                ...
                <div className="mb-4 sm:mb-6">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm sm:text-lg font-bold text-red-600">{interestRate}% p.a.</span>
                  </div>
                  <input
                    type="range"
                    min="9"
                ...
                <div className="mb-4 sm:mb-6">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm sm:text-lg font-bold text-red-600">{tenure} months</span>
                  </div>
                  <input
                    type="range"
                    min="12"
                ...
                <div className="bg-gradient-to-br from-red-50 to-rose-50 rounded-xl p-3 sm:p-4 space-y-3 sm:space-y-4">
                  <div className="flex justify-between items-center pb-2 border-b border-red-200">
                    ...
                    <span className="text-sm sm:text-lg font-bold text-red-600">₹{Math.round(emi).toLocaleString('en-IN')}</span>
                  </div>
                  <div className="flex justify-between items-center pb-2 border-b border-red-200">
                  ...
                  <div className="flex justify-between items-center pt-2 bg-gradient-to-r from-rose-50 to-pink-50 rounded-lg p-2 sm:p-3">
                    <span className="text-xs sm:text-sm font-bold text-red-800">Total Payable</span>
                    <span className="text-base sm:text-xl font-bold text-red-700">₹{Math.round(totalPayable).toLocaleString('en-IN')}</span>
                  </div>
                </div>
                ...
                <div className="mt-4 sm:mt-6 text-center">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full font-semibold hover:opacity-90 transform hover:scale-105 transition-all duration-300 shadow-lg text-sm sm:text-base"
                  >
                    Apply Now
                  </button>
                </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 sticky top-24">
                ...
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center space-x-2">
                    <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold ${formStep >= 1 ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-500'}`}>1</div>
                    <div className={`h-1 w-8 sm:w-12 ${formStep >= 2 ? 'bg-red-600' : 'bg-gray-200'}`}></div>
                    <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold ${formStep >= 2 ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-500'}`}>2</div>
                    <div className={`h-1 w-8 sm:w-12 ${formStep >= 3 ? 'bg-red-600' : 'bg-gray-200'}`}></div>
                    <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold ${formStep >= 3 ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-500'}`}>3</div>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                  {formStep === 1 && (
                    <div className="space-y-3 sm:space-y-4">
                      <h3 className="text-sm sm:text-base font-semibold text-red-700 mb-2 sm:mb-3">Personal & Employment Details</h3>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-3 py-2 text-xs sm:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-3 py-2 text-xs sm:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent uppercase"
                      ...
                      <div>
                        <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1">Existing Loan Amount *</label>
                        <div className="relative">
                          <FileText className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                          <input
                            type="text"
                      ...
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white px-4 py-2 sm:py-3 rounded-full font-semibold hover:opacity-90 transform hover:scale-105 transition-all duration-300 shadow-lg text-sm sm:text-base"
                      >
                  ...
                  {formStep === 2 && (
                    <div className="space-y-3 sm:space-y-4">
                      <h3 className="text-sm sm:text-base font-semibold text-red-700 mb-2 sm:mb-3">Address Details</h3>
                      ...
                      <div className="flex space-x-3">
                        ...
                        <button
                          type="button"
                          onClick={handleNextStep}
                          className="flex-1 bg-gradient-to-r from-red-500 to-red-600 text-white px-4 py-2 sm:py-3 rounded-full font-semibold hover:opacity-90 transform hover:scale-105 transition-all duration-300 shadow-lg text-sm sm:text-base"
                        >
                          Next: Office Address →
                        </button>
                      </div>
                  ...
                  {formStep === 3 && (
                    <div className="space-y-3 sm:space-y-4">
                      <h3 className="text-sm sm:text-base font-semibold text-red-700 mb-2 sm:mb-3">Office Address</h3>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-white px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-center text-gray-800 mb-6 sm:mb-8">
            Why Choose Our <span className="text-red-600">Balance Transfer</span>?
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-gradient-to-br from-red-50 to-rose-50 p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="bg-red-600 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center mb-3 sm:mb-4">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="bg-red-600 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center mb-3 sm:mb-4">
            ...
            <div className="bg-gradient-to-br from-red-50 to-pink-50 p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="bg-red-600 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center mb-3 sm:mb-4">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-red-50 p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="bg-red-600 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center mb-3 sm:mb-4">
            ...
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="bg-red-600 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center mb-3 sm:mb-4">
      ...
      {/* FAQs Section */}
      <section className="py-8 sm:py-12 lg:py-16 bg-gradient-to-br from-red-50 to-rose-50 px-4 sm:px-6">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-red-900 to-red-900 text-white py-6 sm:py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-xs sm:text-sm mb-2">© 2024 KreditScore. All rights reserved.</p>
          <p className="text-xs text-red-200">Your trusted partner for balance transfer solutions.</p>
        </div>
      </footer>
    </div>
  );
