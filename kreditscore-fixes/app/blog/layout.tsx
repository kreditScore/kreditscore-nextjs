...
export const metadata: Metadata = {
  ...
  description:
    "Plain-English articles on credit scores, personal loans, documents, and money tips from KreditScore.",
  openGraph: {
    title: "Blog & Articles | KreditScore",
    description:
      "Updated guides on loans, CIBIL, and personal finance.",
    url: `${SITE_URL}/blog`,
