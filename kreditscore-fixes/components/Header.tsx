  ...
  const navigation: NavItem[] = [
    {
      ...
      items: [
        ...
        { href: '/salaried-overdraft', icon: Wallet, title: 'Salaried Overdraft' },
        { href: '/small-apps-loan', icon: Smartphone, title: 'Small Apps Loan' },
        { href: '/balance-transfer', icon: RefreshCw, title: 'Balance Transfer' },
        { href: '/existing-loan-transfer', icon: FileText, title: 'Existing Loan Transfer', subtitle: 'Without Income Proof' },
        ...
        { href: '/government-employee-loan', icon: Building2, title: 'Government Employee Loan' },
      ]
    },
    {
      label: 'Tools',
      emoji: '🔧',
      items: [
        { href: '/part-payment-calculator', icon: Coins, title: 'Part Payment Calculator' },
        { href: '/company-category', icon: Check, title: 'Company Category Check' },
      ]
    },
    {
      label: 'Company',
